  ...
  export default{
    ...
    methods: {
      ...
      initBrandList() {
        let _this = this
        $.ajax({
          url: baseURL + "WholeDecoration/GetNationwideHouseList_WDBoss",
          data: {
      ...
      houseAllMapbar(list) {
        ...
        let houseAllMapbar = function(list) {
          let obj = {
            datax: [],
            data1: [],
            data2: []
        ...
        let houseAllMapbars = houseAllMapbar(list)
		...
		myChart.on('click', function (param) {
		    ...
		    _this.$emit("changeProvinceHouseID",province);
		});
      },
      map(list) {
        let _this = this
